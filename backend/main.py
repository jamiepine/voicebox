...
async def transcribe_audio(
    ...
    try:
        ...
        # otherwise use default MLX/PyTorch backend
        if language == "he":
...
async def trigger_model_download(request: models.ModelDownloadRequest):
    ...
    model_configs = {
        ...
        "whisper-ivrit-v3": {
            "model_size": "ivrit-v3",
            "load_func": lambda: transcribe.get_pytorch_whisper_model().load_model("ivrit-v3"),
        },
        "whisper-ivrit-v3-turbo": {
            "model_size": "ivrit-v3-turbo",
            "load_func": lambda: transcribe.get_pytorch_whisper_model().load_model("ivrit-v3-turbo"),
        },
        "chatterbox-tts": {
            "model_size": "default",
