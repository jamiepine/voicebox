# Vendored from huggingface/transformers @ main
...
from .._compat import initialization as init
from .._compat import conv1d_output_length
...
# Override: 4.57.6's auto_docstring rejects classes absent from its registry.
from .._compat import auto_docstring  # noqa: F811
